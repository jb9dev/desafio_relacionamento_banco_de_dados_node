# Go Stack 11: Desafio de relacionamento de banco de dados com Nodejs
...
<p style="padding: 0 10px; text-align: center;">:warning:<strong>Antes de rodar os testes, crie um banco de dados com o nome "gostack_desafio09_tests" para que todos os testes possam executar corretamente.</strong>:warning:</p>
